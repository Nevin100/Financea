...
const Page = () => {
  ...
  return (
    <div className="w-full min-h-screen bg-gray-50 flex items-start justify-center px-4 pt-4 pb-8">
      <div className="relative w-full max-w-xs sm:max-w-sm md:max-w-md lg:max-w-lg bg-white rounded-2xl p-5 shadow-xl transition-all h-auto">
        {/* Close Button */}
        <Link href={"/expenses"}>
        ...
        <div className="w-full h-[100px] sm:h-[140px] bg-gray-100 hover:bg-gray-200 transition rounded-xl flex flex-col items-center justify-center cursor-pointer mb-5">
          <svg className="w-6 h-6 text-gray-500 mb-1" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" d="M12 4v16m8-8H4" />
          </svg>
          <p className="text-md text-gray-500">Add Receipt</p>
        </div>
